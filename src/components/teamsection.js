                            ...
                            <div className="flex flex-col items-center">
                                <div className="pt-4 px-5 border-t-2 flex-col flex items-center border-l-2 border-r-2 border-black flex lg:w-96">
                                    <div className="relative w-full">
                                        <img src="/teamtarunpng.png" alt="oliver" className="w-full h-[400px] md:h-auto" />
                ...
                />
                        ...
                        <div className="flex w-full justify-center xl:justify-end">
                            <div className="flex flex-col items-center">
                                <div className="pt-4 px-5 border-t-2 flex-col flex items-center border-l-2 border-r-2 border-black flex lg:w-96">
                                    <div className="relative w-full">
                                        <img src="/dimplekapoor.jpg" className="w-full h-[400px] md:h-auto" alt="Thea" />
                                        <div className="flex justify-center items-center absolute opacity-0 bg-gray-900 hover:opacity-75 w-full h-full top-0">
                                        <div className="cursor-pointer">
                ...
                />
                        ...
                        <div className="flex w-full justify-center xl:justify-end">
                            <div className="flex flex-col items-center">
                                <div className="pt-4 px-5 border-t-2 flex-col flex items-center border-l-2 border-r-2 border-black flex lg:w-96">
                                    <div className="relative w-full">
                                        <img src="/saudkhan.jpg" className="w-full h-[400px] md:h-auto" alt="John" />
                                        <div className="flex justify-center items-center absolute opacity-0 bg-gray-900 hover:opacity-75 w-full h-full top-0">
                                        <div className="cursor-pointer">
                        ...
                        <div className="flex w-full justify-center xl:justify-end">
                            <div className="flex flex-col items-center">
                                <div className="pt-4 px-5 hoverDiv border-t-2 flex-col flex items-center border-l-2 border-r-2 border-black flex lg:w-96">
                                    <div className="relative w-full">
                                        <img src="/ashish.jpg" className="w-full h-[400px] md:h-auto" alt="Dinah" />
                                        <div className="flex justify-center items-center absolute opacity-0 bg-gray-900 hover:opacity-75 w-full h-full top-0">
                                        <div className="cursor-pointer">
                ...
                />
                        ...
                        <div className="flex w-full justify-center xl:justify-end">
                            <div className="flex flex-col items-center">
                                <div className="pt-4 px-5 hoverDiv border-t-2 flex-col flex items-center border-l-2 border-r-2 border-black flex lg:w-96">
                                    <div className="relative w-full">
                                        <img src="/amisha.jpg" className="w-full h-[400px] md:h-auto" alt="sarah" />
                                        <div className="flex justify-center items-center absolute opacity-0 bg-gray-900 hover:opacity-75 w-full h-full top-0">
                                        <div className="cursor-pointer">
                ...
                />
                        ...
                        <div className="flex w-full justify-center xl:justify-end">
                            <div className="flex flex-col items-center">
                                <div className="pt-4 px-5 hoverDiv border-t-2 flex-col flex items-center border-l-2 border-r-2 border-black flex lg:w-96">
                                    <div className="relative w-full">
                                        <img src="/tarunsingh.jpg" className="w-full h-[400px] md:h-auto" alt="Halena" />
                                        <div className="flex justify-center items-center absolute opacity-0 bg-gray-900 hover:opacity-75 w-full h-full top-0">
                                        <div className="cursor-pointer">
                ...
                />
                        ...
                        <div className="flex w-full justify-center xl:justify-end">
                            <div className="flex flex-col items-center">
                                <div className="pt-4 px-5 hoverDiv border-t-2 flex-col flex items-center border-l-2 border-r-2 border-black flex lg:w-96">
                                    <div className="relative w-full">
                                        <img src="/prateekdhawan.JPG" className="w-full h-[400px] md:h-auto" alt="Halena" />
                                        <div className="flex justify-center items-center absolute opacity-0 bg-gray-900 hover:opacity-75 w-full h-full top-0">
                                        <div className="cursor-pointer">
                ...
                />
                        ...
                        <div className="flex w-full justify-center xl:justify-end">
                            <div className="flex flex-col items-center">
                                <div className="pt-4 px-5 hoverDiv border-t-2 flex-col flex items-center border-l-2 border-r-2 border-black flex lg:w-96">
                                    <div className="relative w-full">
                                        <img src="/khizar.JPG" className="w-full h-[400px] md:h-auto" alt="Halena" />
                                        <div className="flex justify-center items-center absolute opacity-0 bg-gray-900 hover:opacity-75 w-full h-full top-0">
                                        <div className="cursor-pointer">
                ...
                />
                        ...
                        <div className="flex w-full justify-center xl:justify-end">
                            <div className="flex flex-col items-center">
                                <div className="pt-4 px-5 hoverDiv border-t-2 flex-col flex items-center border-l-2 border-r-2 border-black flex lg:w-96">
                                    <div className="relative w-full">
                                        <img src="/apala.jpg" className="w-full h-[400px] md:h-auto" alt="Halena" />
                                        <div className="flex justify-center items-center absolute opacity-0 bg-gray-900 hover:opacity-75 w-full h-full top-0">
                                            {/* <div className="cursor-pointer">
                  ...
                  />
                        ...
                        <div className="flex w-full justify-center xl:justify-end">
                            <div className="flex flex-col items-center">
                                <div className="pt-4 px-5 hoverDiv border-t-2 flex-col flex items-center border-l-2 border-r-2 border-black flex lg:w-96">
                                    <div className="relative w-full">
                                        <img src="/salik.jpg" className="w-full h-[400px] md:h-auto" alt="Halena" />
                                        <div className="flex justify-center items-center absolute opacity-0 bg-gray-900 hover:opacity-75 w-full h-full top-0">
                                            {/* <div className="cursor-pointer">
                                                <svg xmlns="http://www.w3.org/2000/svg" width={30} height={30} viewBox="0 0 30 30" fill="none">
                                                    <path
                  ...
                  />
                        ...
                        <div className="flex w-full justify-center xl:justify-end">
                            <div className="flex flex-col items-center">
                                <div className="pt-4 px-5 hoverDiv border-t-2 flex-col flex items-center border-l-2 border-r-2 border-black flex lg:w-96">
                                    <div className="relative w-full">
                                        <img src="/umang.jpg" className="w-full h-[400px] md:h-auto" alt="Halena" />
                                        <div className="flex justify-center items-center absolute opacity-0 bg-gray-900 hover:opacity-75 w-full h-full top-0">
                                            {/* <div className="cursor-pointer">
                                                <svg xmlns="http://www.w3.org/2000/svg" width={30} height={30} viewBox="0 0 30 30" fill="none">
                                                    <path
