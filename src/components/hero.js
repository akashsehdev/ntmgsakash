  ...
  return (
      ...
      <div class="hidden lg:block relative  from-gray-100 to-gray-500 h-[70vh] text-white overflow-hidden">
        <div class="absolute inset-0">
          ...
          <img
            src="/pic16.png"
            alt="Background"
            class="object-cover ml-16 object-center"
          />
    ...
    <p class="text-lg text-gray-300 mb-8">Discover amazing features and services that await you.</p> */}
            <Link to="/register" className="cursor-pointer">
              <button class="bg-black text-gray-100 hover:bg-gray-700 py-2 px-6 text-lg font-semibold transition duration-300 ease-in-out transform hover:scale-105 hover:shadow-lg">
                Enroll Here
              </button>
            </Link>
          </div>
      ...
      <div class="xl:hidden bg-gray-100  mb-4 from-gray-100 to-gray-500 h-80 text-white overflow-hidden">
        <div class="absolute mt-12   ml-2">
          <img
            src="/pic16.png"
            alt="Background "
            class="object-cover  mt-16 w-1/2 h-1/2  object-center"
          />
          {/* <div class="absolute inset-0 bg-black opacity-20"></div> */}
        </div>
    ...
    <p class="text-lg text-gray-300 mb-8">Discover amazing features and services that await you.</p> */}
            <Link to="/register" className="cursor-pointer">
              <button class="bg-black text-gray-100 hover:bg-gray-700 py-2 px-6 text-xs font-semibold transition duration-300 ease-in-out transform hover:scale-105 hover:shadow-lg">
                Enroll Here
              </button>
            </Link>
          </div>
